...
class TestConfig(unittest.TestCase):
    ...
    def test_config_has_app_name(self):
        ...
        self.assertEqual(Config.APP_NAME, 'MediSupply Inventory Processor Backend')
...
class TestDevelopmentConfig(unittest.TestCase):
    ...
    def test_development_config_inherits_app_name(self):
        ...
        self.assertEqual(DevelopmentConfig.APP_NAME, 'MediSupply Inventory Processor Backend')
...
class TestProductionConfig(unittest.TestCase):
    ...
    def test_production_config_inherits_app_name(self):
        ...
        self.assertEqual(ProductionConfig.APP_NAME, 'MediSupply Inventory Processor Backend')
